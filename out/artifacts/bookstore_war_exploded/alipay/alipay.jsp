...
<script language="javascript">
    ...
    function GetDateNow() {
        ...
        document.getElementById("WIDout_trade_no").value = "${param.id}";
        document.getElementById("WIDsubject").value =name;
        document.getElementById("WIDtotal_amount").value = "${param.money}";
        document.getElementById("WIDbody").value="书籍是人类进步的阶梯";
    }
